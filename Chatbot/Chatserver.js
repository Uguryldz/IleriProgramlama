...
var server = net.createServer(function(socket) {
  ...
  console.log(clientName + ' bu oturuma katıldı.');

  // Welcome user to the socket
  socket.write("Hoş geldiniz!\n");

  // Broadcast to others excluding this socket
  broadcast(clientName, clientName + ' bu oturuma katıldı.\n');
  ...
  socket.on('end', function() {
    ...
    var message = clientName + ' bu sohbetten ayrıldı\n';
